...
public class CcobConfiguracaoCobranca implements Serializable {
    ...
    public String toString() {
        return "br.com.chapecosolucoes.trafegusweb.server.beans.CcobConfiguracaoCobranca[ccobCodigo=" + ccobCodigo + "]";
    }
