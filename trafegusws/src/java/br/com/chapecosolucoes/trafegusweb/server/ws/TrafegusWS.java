...
public class TrafegusWS {
    ...
    public String solicitaDadosGridEmViagem(@WebParam(name = "codEmpresa")
    String codEmpresa,@WebParam(name = "offset")
    ...
    public String solicitaListaMotoristas(@WebParam(name = "codEmpresa")
    String codEmpresa,@WebParam(name = "offset")
    String offset) throws Exception {
        //TODO write your implementation code here:
        StringBuilder sb = new StringBuilder();
    ...
    public String solicitaListaEmbarcadores(@WebParam(name = "codEmpresa")
    String codEmpresa,@WebParam(name = "offset")
    String offset) throws Exception {
        //TODO write your implementation code here:
        StringBuilder sb = new StringBuilder();
    ...
    public String solicitaListaTransportadores(@WebParam(name = "offset")
    String offset) throws Exception {
        //TODO write your implementation code here:
        StringBuilder sb = new StringBuilder();
        sb.append(" SELECT ORAS_Objeto_Rastreado.ORAS_Codigo,");
    ...
    public String solicitaDadosEmbarcador(@WebParam(name = "codEmbarcador")
    ...
    public String solicitaListaTipoTransporte(@WebParam(name = "offset")
    String offset) throws Exception {
        //TODO write your implementation code here:
        StringBuilder sb = new StringBuilder();
    ...
    public String solicitaDadosLocal(@WebParam(name = "codLocal")
    ...
    public String solicitaListaCarretasDisponiveis(@WebParam(name = "codEmpresa")
    ...
    public String solicitaListaPGR(@WebParam(name = "offset")
    String offset) throws Exception {
        //TODO write your implementation code here:
        StringBuilder sb = new StringBuilder();
    ...
    public String solicitaDadosPGR(@WebParam(name = "codigo")
    ...
    public String solicitaTotalListaLocais(@WebParam(name = "codEmpresa")
    String codEmpresa) throws Exception {
        //TODO write your implementation code here:
        StringBuilder sb = new StringBuilder();
        sb.append(" SELECT COUNT(*) AS TOTAL FROM ( ");
    ...
    public String solicitaTotalListaEmbarcadores(@WebParam(name = "codEmpresa")
    String codEmpresa) throws Exception {
        //TODO write your implementation code here:
        StringBuilder sb = new StringBuilder();
        sb.append(" SELECT COUNT(*) AS TOTAL FROM ( ");
    ...
    public String solicitaTotalListaMotoristas(@WebParam(name = "codEmpresa")
    String codEmpresa) throws Exception {
        //TODO write your implementation code here:
        StringBuilder sb = new StringBuilder();
        sb.append("      SELECT COUNT(*) AS TOTAL FROM ( ");
    ...
    public String solicitaTotalListaRotas(@WebParam(name = "codEmpresa")
    String codEmpresa) throws Exception {
        //TODO write your implementation code here:
         StringBuilder sb = new StringBuilder();
        sb.append(" SELECT COUNT(*) AS TOTAL FROM ( ");
    ...
    public String solicitaTotalListaVeiculos(@WebParam(name = "codEmpresa")
    String codEmpresa) throws Exception {
        //TODO write your implementation code here:
        StringBuilder sb = new StringBuilder();
        sb.append(" SELECT COUNT(*) AS TOTAL FROM ( ");
    ...
    public String solicitaTotalListaViagemPai(@WebParam(name = "codEmpresa")
    String codEmpresa) throws Exception {
        //TODO write your implementation code here:
        StringBuilder sb = new StringBuilder();
        sb.append(" SELECT COUNT(*) AS TOTAL FROM ( ");
    ...
    public String solicitaTotalHistoricoPosicoes(@WebParam(name = "codEmpresa")
    ...
    public String solicitaTotalDadosGridEmViagem(@WebParam(name = "codEmpresa")
    String codEmpresa) throws Exception {
        //TODO write your implementation code here:
        StringBuilder sb = new StringBuilder();
       sb.append(" SELECT COUNT(*) AS TOTAL FROM ( ");
