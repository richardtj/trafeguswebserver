...
public class AssiAssistente implements Serializable {
    ...
    @Column(name = "assi_codigo", nullable = false)
    private Integer assiCodigo;
    @Column(name = "assi_descricao", length = 50)
    private String assiDescricao;
    @Column(name = "assi_dono", length = 10)
    ...
    public String toString() {
        return "br.com.chapecosolucoes.server.beans.AssiAssistente[assiCodigo=" + assiCodigo + "]";
    }
