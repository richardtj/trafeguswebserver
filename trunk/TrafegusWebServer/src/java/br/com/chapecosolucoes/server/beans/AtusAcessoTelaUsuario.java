...
public class AtusAcessoTelaUsuario implements Serializable {
    ...
    @Column(name = "atus_codigo", nullable = false)
    private Integer atusCodigo;
    @Column(name = "atus_nome_janela", length = 100)
    private String atusNomeJanela;
    @Column(name = "atus_nome_classe", length = 100)
    ...
    public String toString() {
        return "br.com.chapecosolucoes.server.beans.AtusAcessoTelaUsuario[atusCodigo=" + atusCodigo + "]";
    }
