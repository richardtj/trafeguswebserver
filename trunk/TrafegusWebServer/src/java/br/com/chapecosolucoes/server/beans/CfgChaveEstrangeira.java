...
public class CfgChaveEstrangeira implements Serializable {
    ...
    @Column(name = "cce_chave_framework_id", nullable = false)
    private Integer cceChaveFrameworkId;
    @Column(name = "cce_dicionario", length = 50)
    private String cceDicionario;
    @Column(name = "cce_descricao_chave_estrangeira", length = 50)
    private String cceDescricaoChaveEstrangeira;
    @Column(name = "cce_tabela_referenciada", length = 100)
    private String cceTabelaReferenciada;
    @Column(name = "cce_campos_pk", length = 200)
    private String cceCamposPk;
    @Column(name = "cce_campos_referencia", length = 200)
    ...
    public String toString() {
        return "br.com.chapecosolucoes.server.beans.CfgChaveEstrangeira[cceChaveFrameworkId=" + cceChaveFrameworkId + "]";
    }
