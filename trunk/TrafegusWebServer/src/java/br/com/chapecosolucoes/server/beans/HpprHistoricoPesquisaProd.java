...
public class HpprHistoricoPesquisaProd implements Serializable {
    ...
    @Column(name = "hppr_codigo", nullable = false)
    private Integer hpprCodigo;
    @Column(name = "hppr_valor_maximo", precision = 15, scale = 2)
    ...
    public String toString() {
        return "br.com.chapecosolucoes.server.beans.HpprHistoricoPesquisaProd[hpprCodigo=" + hpprCodigo + "]";
    }
