...
public class PproPermissaoProduto implements Serializable {
    ...
    @Column(name = "ppro_codigo", nullable = false)
    private Integer pproCodigo;
    @Basic(optional = false)
    @Column(name = "ppro_id_objeto_produto", nullable = false)
    ...
    public String toString() {
        return "br.com.chapecosolucoes.server.beans.PproPermissaoProduto[pproCodigo=" + pproCodigo + "]";
    }
