...
public class UlsiUltimoLogServicoInteg implements Serializable {
    ...
    @Column(name = "ulsi_lsin_codigo", nullable = false)
    private Integer ulsiLsinCodigo;
    @Column(name = "ulsi_mint_descricao", length = 50)
    private String ulsiMintDescricao;
    @Basic(optional = false)
    @Column(name = "ulsi_data_inicio", nullable = false)
    ...
    public String toString() {
        return "br.com.chapecosolucoes.server.beans.UlsiUltimoLogServicoInteg[ulsiLsinCodigo=" + ulsiLsinCodigo + "]";
    }
