package br.com.chapecosolucoes.trafegusweb.client.components.custompreloader
{
	...
	public class LoadScreen extends Loader {
		...
		//~ Settings ----------------------------------------------------------
		private static var _BarWidth     : int = 400;  // Progress bar width
		private static var _BarHeight    : int = 12;   // Progress bar height
		private static var _LogoHeight   : int = 310;   // Logo picture height
		private static var _LogoWidth    : int = 400;  // Logo picture width
		...
		//~ Instance Attributes -----------------------------------------------
		[Embed(source="/assets/logomarca_trafegus_400_x_310.png")]
