package br.com.chapecosolucoes.trafegusweb.client.controller
{
	...
	public class MapController
	{
		...
		public function onMapReady(e:Event):void
		{
			...
			this.view.posicaoVeiculosArray = new ArrayCollection([MainModel.getInstance().posicaoVeiculoVO]);
		}
		private function mapMouseEventHandler(e:MapMouseEvent):void{
		...
		public function createMarker(posicaoVeiculoVO:PosicaoVeiculoVO):Marker
		{
			...
			marker.addEventListener(MapMouseEvent.CLICK, this.mapMouseEventHandler);
