package br.com.chapecosolucoes.trafegusweb.client.controller
{
	...
	public class ParadasController
	{
		...
		{
			MainModel.getInstance().smVO.paradas.addItem(event.parada);
		}
		public function removeParada():void
		{
			if(this.view.grid.selectedIndex != -1)
			{
				MainModel.getInstance().smVO.paradas.removeItemAt(MainModel.getInstance().smVO.paradas.getItemIndex(this.view.grid.selectedItem));
			}
			else
			{
