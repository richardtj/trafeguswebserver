package br.com.chapecosolucoes.trafegusweb.client.model
{
    ...
    public final class MainModel
    {
		...
		public var classesReferenciaIcons:ArrayCollection = new ArrayCollection([{img:"assets/map/apartment.png"},{img:"assets/map/tollstation.png"},{img:"assets/map/police2.png"},{img:"assets/map/gazstation.png"},{img:"assets/map/hospital.png"},{img:"assets/map/hotel.png"},{img:"assets/map/white20.png"},{img:"assets/map/police.png"},{img:"assets/map/port.png"},{img:"assets/map/airport.png"},{img:"assets/map/police3.png"},{img:"assets/map/tools.png"}]);
