//Referencia - http://danthaiwang.wordpress.com/2010/01/13/google-maps-api-for-flash-encoding-a-polyline/
package br.com.chapecosolucoes.trafegusweb.client.utils
{
    ...
    public class PolylineEncoder
    {
        ...
        public function dpEncodeToJSON(points:Array, color:String, weight:Number, opacity:Number):Object
        {
            ...
            return { color: color, weight: weight, opacity: opacity, points: result.encodedPoints, levels: result.encodedLevels, numLevels: this.numLevels, zoomFactor: this.zoomFactor }
        }
