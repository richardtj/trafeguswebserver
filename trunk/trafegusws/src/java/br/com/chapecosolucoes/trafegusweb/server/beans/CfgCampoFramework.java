...
public class CfgCampoFramework implements Serializable {
    ...
    @Column(name = "cfc_chave_est_tabela")
    private String cfcChaveEstTabela;
    @Column(name = "cfc_campo_tela")
