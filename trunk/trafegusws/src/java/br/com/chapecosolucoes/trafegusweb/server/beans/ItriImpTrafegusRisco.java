...
public class ItriImpTrafegusRisco implements Serializable {
    ...
    public String toString() {
        return "br.com.chapecosolucoes.trafegusweb.server.beans.ItriImpTrafegusRisco[itriCodigo=" + itriCodigo + "]";
    }
